...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('body', old('body',$news->body), array('class'=>'form-control ckeditor')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('description', old('description',$news->descriprion), array('class'=>'form-control')) !!}
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        {!! Form::text('url', old('url',$news->url), array('class'=>'form-control')) !!}
